...
-- number(3)
-- varchar2(20)
-- no, name, kor, eng, math, total, avg, rank 컬럼으로 생성
...
values(1,'홍길동',100,100,99,299,(299/3),0);
...
insert into students
values(6,'김유신',80,80,71,231,(231/3),0);

insert into students
values(7,'홍길자',100,100,90,290,(290/3),0);
...
name varchar2(20),
avg1 number,
avg2 number(5,2) --소수점 지정(5자리 출력하면서 소수점은 2자리만 출력)
);

insert into no_table
values(1,'홍길동',(1000/3),(1000/3));

select * from no_table;

insert into no_table
values(2,'유관순',(1000/6),(500/6));

insert into no_table
values(2,'유관순',(1000/6),(1000/6));

insert into no_table
values(4,'강감찬',(100/6),(100/6));
...
--select * from 테이블명 : (테이블명)의 모든 컬럼 검색
...
update member set name='김유신' where name='Bryan';
commit;

update member set ID='fff' where name='김유신';
commit;
...
select salary,to_char(salary*1384.66,'999,999,999')as salary1 from employees;
