...
# # 리스트 함수-삭제
#a_list.pop(2) # 해당 위치 index의 위치 삭제
# # a_list.remove(3) # 입력된 값 삭제
# a_list.clear() # 전체 삭제
# # del(a_list[3]) # 해당 위치 리스트 삭제
# # print(len(a_list)) # 리스트 개수 
# # print(a_list.count(3)) # 입력된 값의 갯수 출력
#print(a_list)
...
# # a_list[1:3] =[] # 2개 삭제시 - [2,5] 출력
# print(a_list)

# #del 명령어
# del a_list[0] # [2,3,4,5]출력
# print(a_list)
...
# a_list = [1,2,3,4,5]
# b_list = [50,100]
# print(a_list[0:3]) # [1,2,3] 출력
# print(a_list[2:4]) # [3,4] 출력
# print(a_list[:3])  # [1,2,3] 출력
# print(a_list[3:])  # [4,5] 출력
# print(a_list+b_list) # [1,2,3,4,5,50,100] 출력
# print(b_list*3) # [50,100,50,100,50,100]
# print(a_list[::2]) # [1,3,5] 출력
# print(a_list[::-2]) # [5,3,1] 출력
# print(a_list[::-1]) # [5,4,3,2,1] 출력
...
# a_list = [1,2,3,4,5]
# b_list = a_list # 얕은 복사
# a_list[0] = 100 # a_list의 값을 변경하면 b_list 값 변경
# print(a_list)
# print(b_list)
